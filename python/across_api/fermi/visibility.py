...
class FermiVisibility(VisibilityBase, ACROSSAPIBase):
    """Class to calculate Fermi visibility.
...
# Fermi specific aliases for classes
Visibility = FermiVisibility
FermiVisibilityGetSchema = VisibilityGetSchema
FermiVisibilitySchema = VisibilitySchema
